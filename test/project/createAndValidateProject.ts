...
import { ITestContext, testFolderPath } from '../global.test';
...
export async function createAndValidateProject(context: ITestContext, options: ICreateProjectTestOptions): Promise<void> {
